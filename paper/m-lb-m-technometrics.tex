...
\begin{align*}
  \eta_{\pi} & \sim \op{Normal}(-3, 1^2)\\
  \tau_{\pi} & \sim \op{Half-Cauchy}(0, 1)\\
  \eta_{\sigma_2} & \sim \op{Normal}(0, 2^2)\\
  \tau_{\sigma_2} & \sim \op{Half-Cauchy}(0, 1)\\
  \eta_{t_{0.2}} & \sim \op{Normal}(9, 2^2)\\
