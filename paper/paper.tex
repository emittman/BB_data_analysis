...
\cite{betancourt} as implemented in {\tt
  rstan}\cite{rstan}. Multiple chain were run with warmup iterations. Convergence was assessed by examining posterior
...
This should probably be truncated at something like eight years, since the right tails seem unlikely. Sort by left endpoint?
