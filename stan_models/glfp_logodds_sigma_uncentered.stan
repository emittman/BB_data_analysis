...
parameters{
  real eta_ltp1; #locations
  real eta_ltp2;
  real eta_s1;
  real eta_s2;
  real eta_pi;
  real<lower=0> tau_ltp1; #scales
...
transformed parameters{
  ...
  for(m in 1:M)
    ...
    sigma2[m] = inv_logit(eta_s2 + tau_s2 * logit_sigma2_raw[m]);
}
